...
const SEVERITY = {
  'Healthy':               { level: 'mild',     labelKey: 'disease_healthy' },
  'Anxiety':               { level: 'mild',     labelKey: 'sev_monitor' },
  'Arrhythmia':            { level: 'moderate', labelKey: 'sev_consult_doctor' },
  'Heart Attack Risk':     { level: 'serious',  labelKey: 'sev_emergency' },
  'Severe Cardiac Issue':  { level: 'serious',  labelKey: 'sev_emergency' },
}
...
function ResultScreen({ answers, onRestart, onBack }) {
    ...
    return (
      <div className="hc-result-wrapper">
        <div className="hc-result-header">
          ...
          <span className="hc-title">{t('htc_title')}</span>
        </div>
  ...
  const sev = SEVERITY[disease] ?? { level: 'moderate', labelKey: 'sev_consult_doctor' }
  ...
  return (
    <div className="hc-result-wrapper">
      ...
      <div className="hc-result-card">
        <div className="hc-result-label">{t('nc_predicted_cond')}</div>
        ...
        {/* Remedy */}
        <div className="hc-remedy-label">{t('nc_action_plan')}</div>
        <p className="hc-remedy-text" style={{ whiteSpace: 'pre-line' }}>{t(disease === "Heart Attack Risk" || disease === "Severe Cardiac Issue" ? "remedy_heart_emergency" : `remedy_heart_${disease.toLowerCase().replace(/\s+/g, '_')}`)}</p>
      </div>
