...
const SEVERITY = {
  'Migraine':         { level: 'moderate', label: '⚠ Moderate'              },
  'Tension Headache': { level: 'mild',     label: '✓ Mild'                  },
  'Sinusitis':        { level: 'moderate', label: '⚠ Moderate'              },
  'Common Cold':      { level: 'mild',     label: '✓ Mild'                  },
  'Brain Tumor':      { level: 'serious',  label: '🚨 Serious – See Doctor'  },
}
    ...
    return (
      <div className="hc-result-wrapper">
        <div className="hc-result-header">
          ...
          <span className="hc-title">Head Checker</span>
        </div>
        ...
        <div className="hc-result-card" style={{ textAlign: 'center' }}>
          ...
          <p className="hc-remedy-text">
            ...
            However, if you feel unwell or pain increases over time, please
            consult a doctor.
          </p>
        </div>
  ...
  return (
    <div className="hc-result-wrapper">
      ...
      <div className="hc-result-card">
        <div className="hc-result-label">Possible Condition</div>
        ...
        <p className="hc-remedy-text">{remedy}</p>
      </div>
